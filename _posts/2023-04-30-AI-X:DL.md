...
그 후, Kkma 태깅 규칙에 따라 유효한 태깅만 리스트로 반환해 데이터에 추가하였다. <sup>[3](#footnote_3)</sup>
```python
import ast
...
<a name="footnote_2">2</a>: 꼬꼬마 태그 리스트[링크](http://kkma.snu.ac.kr/documents/?doc=postag)
