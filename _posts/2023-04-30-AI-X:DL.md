...
```
![harversine 시각화[(출처: wikipedia)][위키백과Harversine출처]][visualization of harversines]   
...
\<학교 급별 학생수\>   
![학교 급별 개수 boxplot][학교급별개수boxplot]   
\<학교 설립유형별 개수\>   
![학교 설립유형별 개수 boxplot][학교설립유형별개수boxplot]    
\<학교 급별 학생수\>   
![학교 급별 학생수 boxplot][학교급별학생수boxplot]     
자세한 계산 코드는 다음과 같다
```python
